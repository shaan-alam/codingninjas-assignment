  ...
  return (
    <LinksWrapper>
      <LinksContainer>
        ...
        <p>
          <h6>Coding Courses for Beginners</h6>
          <a href="#!">Data Structures and Algorithms</a>
          <a href="#!">Aptitude Preparation</a>
        </p>
        <p>
          <h6>Advanced Coding Courses:</h6>
        ...
        <p>
          ...
          <a href="#!">Full Stack Development with NodeJS</a>
          <a href="#!">Advanced Front End Development with React</a>
          <a href="#!">Data Science and Machine Learning Complete</a>
